const en = {
    ...
    findService: {
        ...
        requestSentSub: 'will contact you shortly.',
        requestError: 'Failed to send request. Please try again.',
        cancelRequest: 'Cancel',
        close: 'Close',
        postJob: 'Post Your Job',
        postJobSub: "We'll send it to nearby providers so they can send you offers",
        postJobBtn: 'Post Job — Get Offers',
        previewBtn: 'Preview Nearby Providers',
    },
    ...
    requestTracking: {
        ...
        statusOpen: 'Waiting for offers',
        statusAwarded: 'Provider selected',
        statusCancelled: 'Cancelled',
        noBidsYet: 'No offers yet — providers nearby have been notified.',
        bidsHeading: 'Offers received',
        award: 'Choose this provider',
        awarding: 'Selecting...',
        awardedTo: 'You selected {{name}} for this job.',
        eta: 'ETA',
        minutes: 'min',
        refresh: 'Refresh',
    },
    ...
    leads: {
        title: 'Leads',
        subtitle: 'Nearby jobs matching your service area',
        empty: 'No open leads in your area right now.',
        yourBid: 'Your bid',
        priceLabel: 'Your Price (₪)',
        etaLabel: 'ETA (minutes)',
        messageLabel: 'Message to customer',
        submitBid: 'Submit Bid',
        updateBid: 'Update Bid',
        submitting: 'Submitting...',
        bidSubmitted: 'Bid submitted',
        bidAwarded: 'You won this lead',
        bidRejected: 'Awarded to another provider',
